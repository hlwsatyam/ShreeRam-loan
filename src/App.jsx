...
import MainHomePage from "./src/App.jsx";
...
function App() {
  ...
  const hideHeaderAndFooter =
    ...
    location.pathname === "/customer-dashboard/users/edit" ||
    location.pathname === "/admin/insert" ||
    location.pathname === "/check-status" ||
    location.pathname === "/excutive-dashboard" ||
    location.pathname === "/add-lead-by-excutive" ||
